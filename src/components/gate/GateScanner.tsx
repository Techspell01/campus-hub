  ...
  return (
    <div className="space-y-4">
      ...
      <details className="glass glass-shine group rounded-glass px-4 py-3">
        ...
        >
          <input
            className="w-full rounded-2xl border border-white/25 bg-white/45 px-3.5 py-2.5 text-[14px] text-ink outline-none transition-colors placeholder:text-ink-faint focus:border-white/45 dark:border-white/12 dark:bg-white/[0.07]"
            value={manualCode}
