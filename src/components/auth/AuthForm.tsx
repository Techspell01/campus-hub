...
const FIELD =
  ...
  "focus:border-violet-400/60 dark:border-white/12 dark:bg-white/[0.07]";
...
export function AuthForm({
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -top-24 -right-20 -z-10 size-64 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 opacity-25 blur-3xl"
      />
